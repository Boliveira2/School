...
ficheiro_excel = "C:/pessoal/AssociacaodePais/School/GestorReceitas/Junho/relatorioMensal_Junho.xlsx"

# Ler a folha do Excel
df = pd.read_excel(ficheiro_excel)

# Pasta onde os ficheiros serão guardados
pasta_saida = "C:/pessoal/AssociacaodePais/School/GestorReceitas/Junho/emails"
...
À data de 31 de Junho de 2025 tem um valor em dívida de: {saldo_formatado}. 
